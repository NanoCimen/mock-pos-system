...
import { Ticket, TicketItem, CreateTicketRequest, AddItemsRequest } from '../../types/index.js';
import { generateId, calculateTicketTotals, determineTicketStatus, shouldSimulateFailure, simulateDelay } from '../../utils/helpers.js';
